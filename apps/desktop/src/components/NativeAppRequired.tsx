  ...
  return (
    <main className="native-required" data-testid="native-app-required">
      <section>
        ...
        <p>
          This browser page does not contain a workspace. Use the native Apple-silicon app to create or join a room. The
          first supported signed alpha will be announced on the product website.
        </p>
