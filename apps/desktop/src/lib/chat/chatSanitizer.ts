...
function isValidChatMessageEnvelope(value: Record<string, unknown>): value is Record<string, unknown> & {
  id: string;
  author: string;
  authorUserId?: string;
  ...
  return (
    ...
    validOptionalChatMetadata(value)
  );
}

function validOptionalChatMetadata(value: Record<string, unknown>): boolean {
  return (
