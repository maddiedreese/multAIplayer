...
import { exportRoomSecret } from "../lib/localHistory";
import { createInvite } from "../lib/workspaceClient";
...
export function createInviteLinkActions(options: InviteLinkActionOptions) {
  const {
    deviceId,
    deviceIdentity,
    hasSelectedRoom,
