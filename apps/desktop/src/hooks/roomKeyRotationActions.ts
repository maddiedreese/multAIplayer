...
import { loadOrCreateRoomSecret, replaceRoomSecret } from "../lib/localHistory";
...
export function createRoomKeyRotationActions(options: RoomKeyRotationActionOptions) {
  const {
    appendRoomMessage,
    deviceId,
    hasSelectedRoom,
