...
fn selected_manifest(version: &str) -> Result<CompatibilityManifest, String> {
...
fn capabilities_for_version(version: &str) -> Result<CodexHostCapabilities, String> {
...
fn bounded_string(value: Option<&Value>, field: &str, max: usize) -> Result<String, String> {
    let value = value
        .and_then(Value::as_str)
...
fn safe_url(value: Option<&Value>, field: &str) -> Result<String, String> {
