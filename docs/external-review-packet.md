...
| Two-shell production-path journey      | `e2e/native-shell/journey.ts`, `e2e/native-shell/invite-scenarios.ts`, `e2e/native-shell/key-package-negative.ts`, `scripts/native-journey-metrics.mjs`, `.github/workflows/ci.yml` |
