...
| `open_browser_view`               | local               | HTTPS/HTTP URL policy, room ID and profile scope checked; profile directory is app-owned. Browser window blocks downloads, clipboard and uploads. Caller-supplied title is not security authority. |
