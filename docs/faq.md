...
GitHub identifies room members and supports repository workflows. ChatGPT authorizes the Codex process on the active host. They are separate accounts and authority domains. GitHub-only identity is an alpha scope decision, not a permanent platform requirement.
