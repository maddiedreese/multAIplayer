...
| CLI-040 | GitHub authentication and secure device identity | waiting_for_owner_approval | CLI-030 |
| CLI-050 | Relay transport and workspace reads | waiting_for_owner_approval | CLI-030, CLI-040 |
| CLI-060 | MLS client state, storage, and outbox | waiting_for_owner_approval | CLI-030, CLI-040 |
| CLI-070 | Room creation and local project association | waiting_for_owner_approval | CLI-050, CLI-060 |
| CLI-080 | Secure invite codes and host-mediated admission | waiting_for_owner_approval | CLI-070 |
| CLI-090 | Encrypted chat, presence, and safe rendering | waiting_for_owner_approval | CLI-050, CLI-060, CLI-080 |
| CLI-100 | Reconnect, replay, history, and crash recovery | waiting_for_owner_approval | CLI-090 |
| CLI-110 | UI-independent Codex host extraction | waiting_for_owner_approval | CLI-020 |
| CLI-120 | Codex proposals, context, and hosted turns | waiting_for_owner_approval | CLI-090, CLI-110 |
| CLI-130 | Privileged approvals and shared activity | waiting_for_owner_approval | CLI-120 |
| CLI-140 | Desktop/CLI interoperability journeys | waiting_for_owner_approval | CLI-100, CLI-130 |
| CLI-150 | Security hardening and threat-model update | waiting_for_owner_approval | CLI-140 |
| CLI-160 | Signed CLI packaging and release isolation | waiting_for_owner_approval | CLI-150 |
| CLI-170 | External-alpha readiness review | waiting_for_owner_approval | CLI-160 |
